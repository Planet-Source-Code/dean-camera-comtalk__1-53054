...
Begin VB.Form PluginMainIcon 
   ...
   Begin VB.Image Image1 
      Height          =   480
      Left            =   120
      Picture         =   "Icon.frx":BAA4
      Top             =   0
      Width           =   480
   End
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Description Of Plugin"
      Height          =   615
      Left            =   120
      TabIndex        =   1
      Top             =   480
   ...
   End
End
Attribute VB_Name = "PluginMainIcon"
...
If GetSetting("ComTalk", "Plugins", "Plugin " & i, "") = "PluginTemplate.MSNAloudMain" Then
Exit Sub
End If
Next
SaveSetting "ComTalk", "Plugins", "Count", plugcount + 1
SaveSetting "ComTalk", "Plugins", "Plugin " & plugcount + 1, "PluginTemplate.MSNAloudMain"
End Sub
